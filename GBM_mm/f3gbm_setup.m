...
gbm = struct('n_x',[],'n_y',[],'n_h',256,'n_f',1024, ...
    ...
    'zeromask', 'none','batchsize',500,'n_epoch',100,'seed',[],...
    'initMultiplierW',0.05,'batchOrderFixed',false,'weightPenaltyL2',0.001,...
    'everySave',1,'wxf',[],'wyf',[],'whf',[],'wy',[],'wh',[],...
    'deltaMax',0.01,'n_batch',[],'visType','binary','saveFile',true,'zeromaskOriginal',[],...
    ...
    'validation_figure',[], ...
    'validation_mean_sqerror',[] ...
    );
    %the last several (separated by ...) rows are added by Chengxu Zhuang to get plot display and
    %validation
